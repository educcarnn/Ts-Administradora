...
import AnexosFormJuridica from "../anexos";
import LoginFormFields from "../login";
import SocioAdministrador from "../socio";
...
export default function PessoaJurModal({
            ...
            <RowContainer>
              <Label>
                ...
                <TextField
                  ...
                  helperText={errors.nomeFantasia ? "Preencha este campo" : ""}
                />
              </Label>
              <Label>
