...
function SidebarUserJuridica () {
    ...
    switch (item) {
      ...
      default:
        ...
        if (itemInfo[item]) {
          ...
          history.push(`/userjur/${item.toLowerCase()}`);
        }
    }
  };

  const handleImoveisClick = () => {
    history.push("/userjur/imoveis-cadastrados");
    setShowImoveisOptions(false);
  };

  const handleContratoClick = () => {
    history.push("/userjur/novo-contrato");
    setShowImoveisOptions(false);
  ...
  const handleListaImoveisCadastrados = () => {
    history.push("/userjur/imovel-cadastro");
    handleModalClose();
  };

  const handleListaContrato = () => {
    history.push("/userjur/obter-contratos");
    handleModalClose();
  };
...
export default SidebarUserJuridica;
